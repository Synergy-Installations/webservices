        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="px-4 sm:px-6">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-500 via-slate-900 to-slate-900 pb-4">Get started with Synergy</h1>
              <p className="text-lg text-slate-500">Talk to an expert about your requirements, needs, and timeline. Complete the form and we'll make sure to reach out.</p>
            </div>
            ...
            <div className="max-w-[25rem] mx-auto p-6 rounded-lg shadow-2xl bg-gradient-to-b from-slate-100 to-slate-50/.7 relative before:absolute before:-top-12 before:-left-16 before:w-96 before:h-96 before:bg-slate-900 before:opacity-[.15] before:rounded-full before:blur-3xl before:-z-10">
              ...
              <form>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm text-slate-800 font-medium mb-2" htmlFor="name">Full Name</label>
                    <input id="name" className="form-input text-sm w-full" type="text" placeholder="Patrick Rossi" required />
                  </div>
                  <div>
                    <label className="block text-sm text-slate-800 font-medium mb-2" htmlFor="email">Work Email</label>
                ...
                <div className="mt-5">
                  <button className="btn text-slate-100 bg-slate-900 hover:bg-slate-800 w-full shadow">Request Demo</button>
                </div>
              </form>
