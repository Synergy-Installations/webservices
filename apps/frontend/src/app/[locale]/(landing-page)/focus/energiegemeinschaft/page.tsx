...
export const metadata = {
  alternates: {
    canonical: "https://synergie.cc/focus/energiegemeinschaft",
  },
};
...
export default function Page(): JSX.Element {
  ...
  return (
    <>
      ...
      />
      <ScrollUp />
      <PhotovoltaicHero translationProduct="Energy-Community" />
      <PhotovoltaicComponents translationProduct="Energy-Community" />
      <PhotovoltaicBackground translationProduct="Energy-Community" />
      <PhotovoltaicTestimonials translationProduct="Energy-Community" />
      <PhotovoltaicCta translationProduct="Energy-Community" />
    </>
  );
}
