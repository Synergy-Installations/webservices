...
export const metadata = {
  alternates: {
    canonical: "https://synergie.cc/focus/notstromversorgung",
  },
};
...
export default function Page(): JSX.Element {
  ...
  return (
    <>
      ...
      />
      <ScrollUp />
      <PhotovoltaicHero translationProduct="Emergency-Power-Supply" />
      <PhotovoltaicComponents translationProduct="Emergency-Power-Supply" />
      <PhotovoltaicBackground translationProduct="Emergency-Power-Supply" />
      <PhotovoltaicTestimonials translationProduct="Emergency-Power-Supply" />
      <PhotovoltaicCta translationProduct="Emergency-Power-Supply" />
    </>
  );
}
