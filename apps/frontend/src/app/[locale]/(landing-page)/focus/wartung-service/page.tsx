...
export const metadata = {
  alternates: {
    canonical: "https://synergie.cc/focus/wartung-service",
  },
};
...
export default function Page(): JSX.Element {
  ...
  return (
    <>
      ...
      />
      <ScrollUp />
      <PhotovoltaicHero translationProduct="Maintenance-Service" />
      <PhotovoltaicComponents translationProduct="Maintenance-Service" />
      <PhotovoltaicBackground translationProduct="Maintenance-Service" />
      <PhotovoltaicTestimonials translationProduct="Maintenance-Service" />
      <PhotovoltaicCta translationProduct="Maintenance-Service" />
    </>
  );
}
