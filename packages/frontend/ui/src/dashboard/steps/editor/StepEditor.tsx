            ...
            >
              <li>
                <button
                  ...
                  type="button"
                  className="flex justify-between items-center w-full text-sm font-sans rounded-sm px-3 py-2 hover:bg-gray-100 text-gray-900 dark:hover:bg-gray-600 dark:text-white"
                >
                  Default
                </button>
              </li>
    ...
    <div className="relative w-full border border-gray-200 rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
      ...
      <EditorProvider
        ...
        editorProps={{
          attributes: {
            class:
              "block w-full px-4 py-2 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 focus:outline-none",
          },
        }}
      ></EditorProvider>
    </div>
