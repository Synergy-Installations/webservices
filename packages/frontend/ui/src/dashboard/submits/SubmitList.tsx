  ...
  return (
    <div className="flex flex-col gap-2 p-4 mt-12">
      {submits.data.map((data: any, index: number) => (
        <div className=" flex items-center justify-between border border-synergy-light-grey p-2 rounded-xl hover:bg-synergy-light-grey transition-colors duration-200">
          <Link
