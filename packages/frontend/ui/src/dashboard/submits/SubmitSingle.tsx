              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex gap-1 text-sm justify-center items-center px-4 py-1 bg-synergy-light-blue rounded-lg text-white"
                  >
                    View
                  </button>
                  <button
                    ...
                    className="flex gap-1 text-sm justify-center items-center px-2 py-1 bg-synergy-light-blue rounded-lg text-white"
                  >
                    Speichern
                  </button>
                </div>
                ...
                <div className="grid gap-1 mt-1">
                  {Object.keys(statusInput).map((key) => (
                    <div key={key} className="flex items-center gap-2">
                      <div
                        ...
                        style={{ backgroundColor: statusInput?.color }}
                      ></div>
                      <label
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          statusInput[key as keyof typeof statusInput] ?? ""
                        }
                        onChange={(e) =>
                          setStatusInput({
                            ...statusInput,
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <button
                      ...
                      className="flex gap-1 w-full justify-center items-center px-2 py-1 bg-synergy-light-blue rounded-lg text-white"
                    >
                      View
                    </button>
                    <button
