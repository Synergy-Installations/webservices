...
import { IsUpdateSubmitLoadingState } from "@com.synergy/frontend-ui/StepsSubmit";

/* eslint-disable-next-line */
export interface SingleSubmitTabsProps {
  params: { id: string };
  SingleStepTabsEdit?: SingleSubmitTabsEdit;
}

interface SingleSubmitTabsEdit {
  ...
  isUpdateStepLoading: IsUpdateSubmitLoadingState;
  setIsUpdateStepLoading: React.Dispatch<
    React.SetStateAction<IsUpdateSubmitLoadingState>
  >;
}

export const SingleSubmitTabs = (props: SingleSubmitTabsProps) => {
  const {
    params: { id },
    SingleStepTabsEdit,
  } = props;
      ...
      <ul className="grid grid-cols-3 xs:flex text-sm font-medium text-gray-500 dark:text-gray-400 !p-2 gap-2 overflow-x-auto">
        <li>
          <Link
            ...
            className={`inline-flex items-center justify-center px-4 py-2 ${isSteps ? "text-white bg-blue-700 dark:bg-blue-600" : "hover:text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"} rounded-lg active w-full `}
            aria-current="page"
          >
            <svg
        ...
        <li>
          <Link
            href={`/dashboard/submits/${id}/chats`}
        ...
        {SingleStepTabsEdit && SingleStepTabsEdit.editStepToggle && (
          <li className="">
            ...
            >
              ...
              <div className="">
                {(SingleStepTabsEdit.isUpdateStepLoading.assets ||
...
export default SingleSubmitTabs;
