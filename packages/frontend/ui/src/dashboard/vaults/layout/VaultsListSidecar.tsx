...
export interface VaultsListSidecarProps {
...
export const VaultsListSidecar = (props: VaultsListSidecarProps) => {
    ...
    <>
      ...
      <div className="flex justify-between h-full">
        ...
        >
          ...
          <VaultsList className="pb-60" params={params} />
        </aside>
        <div className="hidden md:block w-1/3">
          <SingleSubmitTabs params={params} />
          <VaultsList className="pb-48" params={params} />
        </div>
...
export default VaultsListSidecar;
