  ...
  return (
    <div className="">
      <ul className="grid grid-cols-3 xs:flex text-sm font-medium text-gray-500 dark:text-gray-400 !p-2 gap-2 overflow-x-auto">
        ...
        {SingleVaultTabsEdit && SingleVaultTabsEdit.editVaultToggle && (
          <li className="">
            <button
              onClick={() => SingleVaultTabsEdit.setSaveVaultToggle(true)}
            ...
            >
              ...
              <div className="">
                {(SingleVaultTabsEdit.isUpdateVaultLoading.titleDesc ||
                  SingleVaultTabsEdit.isUpdateVaultLoading.membersRights) && (
                  <svg
                    aria-hidden="true"
                    role="status"
