      ...
      <div className="ml-6 md:ml-12">
        <ol className="relative border-s-2 border-gray-200 dark:border-gray-700">
          <li className="mx-4 relative">
            <div className="sticky z-10 top-[4rem] pt-[1.5rem] grid lg:flex items-center gap-2 px-2 rounded-b-xl bg-slate-50/90 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none">
              <div className="">
              ...
              <div className="w-full max-w-6xl mx-auto">
                <div className="flex flex-wrap items-center p-2 md:p-4 max-w-5xl justify-between w-full gap-3 md:gap-2 bg-transparent md:bg-synergy-light-blue/30 md:backdrop-blur-sm rounded-xl">
                  {DiamondClipsArray.map(({ src, alt, text }, idx) => (
                    <DiamondClips key={idx} src={src} alt={alt} text={text} />
                  ))}
                </div>
              </div>
            </div>
