  ...
  return (
    <li className="mx-4 relative">
      <section className="scroll-mt-10" id={service}>
        <div className="z-10 top-[3.5rem] pt-1 xs:pt-[4rem] grid gap-2 max-w-6xl mx-auto px-2 lg:px-0 rounded-b-xl bg-slate-50/90 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none">
