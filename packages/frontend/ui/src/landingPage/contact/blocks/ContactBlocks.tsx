        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-6 lg:gap-16 text-center">
          ...
          <div>
            <div className="w-8 h-8 bg-slate-50 border border-slate-200 rounded-md inline-flex items-center justify-center mb-3">
              <svg className="fill-slate-800" xmlns="http://www.w3.org/2000/svg" width="16" height="17">
            ...
            <h3 className="font-inter-tight font-semibold text-slate-800 mb-1">Personal</h3>
            <p className="text-sm text-slate-500">We can help you choose the right plan for your team.</p>
          </div>
          {/* Item #2 */}
          <div>
            <div className="w-8 h-8 bg-slate-50 border border-slate-200 rounded-md inline-flex items-center justify-center mb-3">
              <svg className="fill-slate-800" xmlns="http://www.w3.org/2000/svg" width="14" height="13">
            ...
            <h3 className="font-inter-tight font-semibold text-slate-800 mb-1">Metrics</h3>
            <p className="text-sm text-slate-500">We can help you choose the right plan for your team.</p>
          </div>
          {/* Item #3 */}
          <div>
            <div className="w-8 h-8 bg-slate-50 border border-slate-200 rounded-md inline-flex items-center justify-center mb-3">
              <svg className="fill-slate-800" xmlns="http://www.w3.org/2000/svg" width="16" height="14">
            ...
            <h3 className="font-inter-tight font-semibold text-slate-800 mb-1">Flexible</h3>
            <p className="text-sm text-slate-500">We can help you choose the right plan for your team.</p>
          </div>
        </div>
      </div>
