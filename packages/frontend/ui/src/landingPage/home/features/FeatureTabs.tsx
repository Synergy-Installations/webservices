...
import FeatureIllustration from "../../../shared/images/features-illustration.png";
...
export const FeatureTabs = (props: FeatureTabsProps) => {
  ...
  return (
    <section className="relative bg-slate-800 after:absolute after:top-0 after:right-0 after:h-full after:w-96 after:pointer-events-none after:bg-gradient-to-l after:from-slate-800 max-lg:after:hidden">
        ...
        <div className="max-w-xl lg:max-w-6xl mx-auto px-4 sm:px-6">
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                <div className="inline-flex text-sm font-medium text-slate-400 px-4 py-0.5 border border-transparent [background:linear-gradient(theme(colors.slate.800),theme(colors.slate.800))_padding-box,linear-gradient(120deg,theme(colors.slate.700),theme(colors.slate.700/0),theme(colors.slate.700))_border-box] rounded-full mb-4">
                  Scale Your Team
                </div>
                <h3 className="font-inter-tight text-3xl font-bold text-slate-200 mb-4">
              ...
              <div className="mb-8 md:mb-0 space-y-2">
                <button
                  className={`text-left flex items-center px-6 py-4 rounded border border-transparent ${tab !== 1 ? "" : "[background:linear-gradient(#2E2E32,#2E2E32)_padding-box,linear-gradient(120deg,theme(colors.slate.700),theme(colors.slate.700/0),theme(colors.slate.700))_border-box]"}`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(1);
                  }}
                >
                  <svg
                    className="shrink-0 fill-slate-400 mr-3"
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-slate-200 mb-1">
                ...
                <button
                  className={`text-left flex items-center px-6 py-4 rounded border border-transparent ${tab !== 2 ? "" : "[background:linear-gradient(#2E2E32,#2E2E32)_padding-box,linear-gradient(120deg,theme(colors.slate.700),theme(colors.slate.700/0),theme(colors.slate.700))_border-box]"}`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(2);
                  }}
                ...
                <button
                  className={`text-left flex items-center px-6 py-4 rounded border border-transparent ${tab !== 3 ? "" : "[background:linear-gradient(#2E2E32,#2E2E32)_padding-box,linear-gradient(120deg,theme(colors.slate.700),theme(colors.slate.700/0),theme(colors.slate.700))_border-box]"}`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(3);
                  }}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-slate-200">
                  Discussions
                </h3>
              </div>
