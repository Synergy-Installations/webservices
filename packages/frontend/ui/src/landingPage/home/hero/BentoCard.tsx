    ...
    >
      <div className="">
        ...
        <p className="relative bottom-0 z-10 left-0 h-0 group-hover:h-auto text-white text-left -m-12 mt-8 group-hover:mt-0 mx-6 opacity-100 group-hover:opacity-100 group-hover:pb-12 text-md transition-transform">
          ...
          {description && (
            <p className="text-md opacity-100 whitespace-pre-wrap font-normal">
              {description}
            </p>
          )}
          <button className="relative flex items-center w-fit mt-2 py-1.5 bottom-0 left-0 px-3 text-white rounded-lg backdrop-blur-md bg-gradient-to-t from-synergy-light-blue via-synergy-light-blue/70 to-synergy-light-blue hover:from-synergy-light-blue hover:to-synergy-light-blue shadow-xl group-hover:opacity-100 text-sm transition-all">
