...
import { AnimatedBeam } from "@com.synergy/frontend-ui/AnimatedBeam";

/* eslint-disable-next-line */
export interface AnimatedBeamMultipleOutputsProps {
  className?: string;
}
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={`
        "z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] ${className}`}
    >
      {children}
    </div>
  );
...
export const AnimatedBeamMultipleOutputs = (
  props: AnimatedBeamMultipleOutputsProps
) => {
  ...
  return (
    <div
      className={`relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl ${props.className}`}
      ref={containerRef}
    >
...
export default AnimatedBeamMultipleOutputs;
