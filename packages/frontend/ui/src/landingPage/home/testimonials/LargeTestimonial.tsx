...
import TestimonialImg from "../../../shared/images/large-testimonial.jpg";

/* eslint-disable-next-line */
export interface LargeTestimonialProps {}

export const LargeTestimonial = (props: LargeTestimonialProps) => {
  return (
    <section>
