...
export const HeroVideoFull = (props: HeroVideoFullProps) => {
  ...
  return (
    <div className="relative w-svw min-h-[100svh]">
      <div className="relative z-20 h-full min-h-[920px] sm:min-h-[893px] flex flex-col items-center justify-end py-12 lg:block lg:pt-[280px] lg:pl-[140px] w-auto">
        ...
        <div className="grid sm:grid-cols-2 w-fit sm:mt-9 gap-5">
