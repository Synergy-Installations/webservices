...
import Stripes from "../../../shared/images/stripes-dark.svg";

/* eslint-disable-next-line */
export interface CtaBarsProps {}

export const CtaBars = (props: CtaBarsProps) => {
  return (
    <section>
        ...
        >
          ...
          <div className="px-4 py-12 md:px-12 md:py-20">
            <h2 className="mb-6 border-y text-3xl font-bold text-gray-200 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.700/.7),transparent)1] md:mb-12 md:text-4xl">
              Create your next project with Synergy
            </h2>
